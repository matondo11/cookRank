 ...
 * `prisma.user`: Exposes CRUD operations for the **User** model.
  ...
  */
    ...
    /**
     * `prisma.recipeSubmission`: Exposes CRUD operations for the **RecipeSubmission** model.
      * Example usage:
      * ```ts
      * // Fetch zero or more RecipeSubmissions
      * const recipeSubmissions = await prisma.recipeSubmission.findMany()
      * ```
      */
    get recipeSubmission(): Prisma.RecipeSubmissionDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
